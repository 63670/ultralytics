...
class SGAM(nn.Module):
    """Spatial gated attention that refines scale-specific features before detection."""
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Generate bounded spatial gates and add their refined response to the residual feature."""
