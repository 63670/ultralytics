...
| --- | --- | ---: | ---: | ---: | ---: |
| YOLOv5n | Ultralytics | 2.50M | 7.1 | 0.931 | 0.584 |
| YOLOv8n | Ultralytics | 3.01M | 8.1 | 0.941 | 0.593 |
...
| Variant | WWTE | LTFR | Parameters | GFLOPs | mAP50 | mAP50-95 | Change vs. YOLOv8n |
| --- | :---: | :---: | ---: | ---: | ---: | ---: | ---: |
| YOLOv8n baseline | No | No | 3.01M | 8.1 | 0.941 | 0.593 | — |
| Baseline + WWTE | Yes | No | 3.28M | 8.8 | 0.942 | 0.641 | +0.048 |
| Baseline + LTFR | No | Yes | 3.11M | 8.2 | 0.943 | 0.609 | +0.016 |
| **DACP-Net** | **Yes** | **Yes** | **3.39M** | **8.9** | **0.969** | **0.663** | **+0.070** |
