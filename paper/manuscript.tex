...
\begin{figure*}[!t]
\centering
\resizebox{0.98\textwidth}{!}{\input{figures/system_overview.tex}}
...
\begin{figure*}[!t]
\centering
\resizebox{0.94\textwidth}{!}{\input{figures/network.tex}}
...
\begin{figure*}[!t]
\centering
\resizebox{0.88\textwidth}{!}{\input{figures/modules.tex}}
\caption{Internal structures of (a) WWTE and (b) LTFR. WWTE uses three depthwise branches and residual fusion. LTFR generates location-specific $5\times5$ reassembly kernels at scale $2$.}
\label{fig:modules}
\end{figure*}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=.97\textwidth]{tradeoff.pdf}
